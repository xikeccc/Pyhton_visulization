...
prediction_train = training_df['Prediction YSI']
actual_train = training_df['Actual YSI']
prediction_test = test_df['Prediction YSI']
actual_test = test_df['Actual YSI']
...
############        CN
training_df = pd.read_excel('CN_own.xlsx', sheet_name='training')
test_df = pd.read_excel('CN_own.xlsx', sheet_name='test')
...
############        KV
training_df = pd.read_excel('KV_own.xlsx', sheet_name='training')
test_df = pd.read_excel('KV_own.xlsx', sheet_name='test')
...
############        MON
training_df = pd.read_excel('MON_own.xlsx', sheet_name='training')
test_df = pd.read_excel('MON_own.xlsx', sheet_name='test')
...
############       IT
training_df = pd.read_excel('IT_own.xlsx', sheet_name='training')
test_df = pd.read_excel('IT_own.xlsx', sheet_name='test')
